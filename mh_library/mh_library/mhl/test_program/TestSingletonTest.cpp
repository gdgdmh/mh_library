#include "TestSingletonTest.hpp"

#include <mhl/system/singleton/MhSingleton.hpp>
...
bool test_program::TestSingletonTest::TestCleanup()
{
    ...
    sc.Add([this]()
    {
        output_console_->PrintLine("Singleton Test Add1");
    });
    sc.Add([this]()
    {
        output_console_->PrintLine("Singleton Test Add2");
    });
    sc.Execute();
    sc.Finalize();
    return true;
