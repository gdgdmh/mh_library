...
#include <memory>
#include <mhl/test_program/route_search/FieldPosition.hpp>
#include <mhl/test_program/route_search/FieldType.hpp>
...
namespace test_program
{
    ...
    namespace route_search
    {
        ...
        public:
             ...
             */
            FieldInfo(const FieldType &type,
             ...
             * @param position フィールドの位置
             */
            void SetPosition(const FieldPosition &position)
            {
                position_ = position;
            }
