...
namespace test_program
{
    ...
    public:
        ...
        ~TestTukuroDelegate() override
        {
        }

        void operator()(int value) override
        {
            (m_obj.get()->*m_func)(value);
        }

        using EventFunc = void(T::*)(int);
    ...
    private:
        std::shared_ptr<mhl::output::console::IConsoleOutputables> console;
