...
class TestMoveDummy {
 public:
   ...
   */
  TestMoveDummy(std::shared_ptr<mhl::output::console::IOutputConsole>& output_console);
...
class TestMoveTest : public mhl::UnitTestBase {
 public:
   ...
   * @param output_console
   */
  TestMoveTest(std::shared_ptr<mhl::output::console::IOutputConsole> output_console);
