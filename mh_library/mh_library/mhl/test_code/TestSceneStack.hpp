...
namespace test_code
{
    ...
    public:
         ...
         */
        void SetUnderUpdate(bool under_update) override;
         ...
         */
        void SetUnderDraw(bool under_draw) override;
         ...
         */
        bool IsUnderDraw() override;

        /**
         * @brief このシーンがポップ処理をされる前に呼び出される
         *
         */
        void EventPop() override;
         ...
         */
        void EventPush(std::shared_ptr<ISceneable> next) override;
         ...
         */
        void EventSwap(std::shared_ptr<ISceneable> next) override;
