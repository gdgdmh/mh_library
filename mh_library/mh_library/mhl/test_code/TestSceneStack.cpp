...
#include <mhl/scene/SceneStack.hpp>
 ...
 *
 */
void test_code::TestScene::Initialize()
{
    ++call_initialize_;
}
 ...
 *
 */
void test_code::TestScene::Release()
{
    ++call_release_;
}
 ...
 *
 */
void test_code::TestScene::Update()
{
    ++call_update_;
}
 ...
 */
bool test_code::TestScene::IsUnderUpdate()
{
    return under_update_;
}
 ...
 */
bool test_code::TestScene::IsUnderDraw()
{
    return under_draw_;
}
 ...
 *
 */
void test_code::TestScene::EventPop()
{
    ++call_event_pop_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetInitializeCall()
{
    return call_initialize_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetReleaseCall()
{
    return call_release_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetLoadCall()
{
    return call_load_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetUpdateCall()
{
    return call_update_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetDrawCall()
{
    return call_draw_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetEventPopCall()
{
    return call_event_pop_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetEventPushCall()
{
    return call_event_push_;
}
 ...
 * @return int コールされた回数
 */
int test_code::TestScene::GetEventSwapCall()
{
    return call_event_swap_;
}
...
void test_code::TestSceneStack::TestInitializeCall()
{
    ...
    std::shared_ptr<TestScene> test(new TestScene());
...
{
    mhl::SceneStack stack;
    std::shared_ptr<TestScene> test_first(new TestScene());
    std::shared_ptr<TestScene> test(new TestScene());
