...
#include <mhl/system/file/text/ITextfileWriter.hpp>
#include <string>
#include <vector>
...
namespace mhl
{
    ...
    namespace output
    {
        ...
        namespace log
        {
            ...
            // ログ出力クラス
            class OutputLog : public ILogOutputable
            {
            public:
                /**
                 * @brief コンストラクタ
                 ...
                 */
                OutputLog(
                    const std::shared_ptr<system::file::text::ITextfileWriter> &writer);
                ...
                bool Initialize(const std::string &file_name,
                                system::file::text::Mode mode) override;
            ...
            private:
                std::shared_ptr<system::file::text::ITextfileWriter> writer_;
            };
