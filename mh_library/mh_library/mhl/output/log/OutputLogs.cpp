 ...
 *
 */
mhl::output::log::OutputLogs::OutputLogs() :
    outputable_()
{
}
 ...
 * @return false 終了処理失敗
 */
bool mhl::output::log::OutputLogs::Finalize()
{
    return Clear();
}
 ...
 */
size_t mhl::output::log::OutputLogs::Size() const
{
    return outputable_.size();
}
