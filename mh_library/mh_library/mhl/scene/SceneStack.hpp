...
namespace mhl
{
    ...
    public:
         ...
         */
        void Push(const std::shared_ptr<ISceneable> &scene);
         ...
         */
        void Swap(const std::shared_ptr<ISceneable> &scene);
    ...
    private:
         ...
         * @param scene 対象のシーン
         */
        void InitializeScene(const std::shared_ptr<ISceneable> &scene);
         ...
         * @param scene 対象のシーン
         */
        void EndScene(const std::shared_ptr<ISceneable> &scene);

        std::list<std::shared_ptr<ISceneable>> stack_;
    };
