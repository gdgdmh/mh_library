...
#define MHL_ASSERT(expr, msg) _ASSERT_EXPR(expr, msg)
            ...
            public:
                ...
                MhlAssertion(
                    ...
                    std::unique_ptr<output::console::IConsoleOutputables> &&
                    output_console,
                    std::unique_ptr<stacktrace::IStacktraceable> &&stacktrace);
            ...
            private:
                ...
                // コンソール出力
                std::unique_ptr<output::console::IConsoleOutputables> output_console_;
                // スタックトレース情報
                std::unique_ptr<stacktrace::IStacktraceable> stacktrace_;
            };
